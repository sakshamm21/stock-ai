...
import { getOpenAIApiKey, setOpenAIApiKey, getFinancialDataApiKey, setFinancialDataApiKey } from '@/lib/db/api-keys';
...
export function ApiKeysModal({ 
  ...
  const [financialKey, setFinancialKey] = useState(getFinancialDataApiKey() || '');
  ...
  const handleSave = async () => {
    try {
      ...
      await Promise.all([
        ...
        setFinancialDataApiKey(financialKey)
      ]);
