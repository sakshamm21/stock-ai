...
export const StockAILogo = ({ size = 32 }: { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 48 48"
  ...
  >
    ...
    <rect
      ...
      height="44"
      rx="12"
      fill="url(#stockai-gradient)"
    />
    {/* Candlestick chart */}
    <rect x="12" y="20" width="4" height="14" rx="1" fill="white" />
    <rect x="11" y="17" width="6" height="3" rx="0.5" fill="white" opacity="0.7" />
    <rect x="22" y="12" width="4" height="22" rx="1" fill="white" />
    <rect x="21" y="9" width="6" height="3" rx="0.5" fill="white" opacity="0.7" />
    <rect x="32" y="16" width="4" height="18" rx="1" fill="white" />
    <rect x="31" y="13" width="6" height="3" rx="0.5" fill="white" opacity="0.7" />
    {/* Upward trend line */}
    <path
      d="M10 34L20 26L28 30L38 20"
      stroke="white"
      strokeWidth="2.5"
      strokeLinecap="round"
      strokeLinejoin="round"
