        ...
        {suggestedActions.map((suggestedAction, index) => (
          ...
          >
            <Button
              ...
              className="text-left border rounded-xl px-4 py-3.5 text-sm flex-1 gap-1 sm:flex-col w-full max-w-[calc(100vw-2rem)] h-auto justify-start items-start break-words card-lift hover:border-primary/30 hover:bg-primary/5"
            >
